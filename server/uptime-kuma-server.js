...
class UptimeKumaServer {
     ...
     * @param {number|null} monitorID The ID of monitor for.
     * @param {object} opts Options
     * @param {boolean} opts.rootOnly If true, only return root (parent IS NULL) monitors
     * @returns {Promise<object>} A promise that resolves to an object with monitor IDs as keys and monitor objects as values.
     */
    async getMonitorJSONList(userID, monitorID = null, opts = {}) {
        let query = " user_id = ? ";
        ...
        const monitorList = await R.find("monitor", query + "ORDER BY weight DESC, name", queryParams);
